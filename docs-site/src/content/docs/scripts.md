---
title: "剧本管理"
description: "「剧本管理」是你导入、浏览和配置小说剧本的中枢。上传一部 TXT 文件后，系统会自动识别章节结构并切分，之后可以构建向量索引、提取 NPC 角色卡和世界观条目，然后基于该剧本开始游戏或继续已有存档。"
---
...
如需对剧本内容做结构化编辑（修改世界书条目、时间线、NPC 设定等），可使用 [剧本编辑器](/md-editor)——它是 VSCode 风格的多栏 IDE，支持 AI 辅助续写与改写，适合深度编辑场景。
...
- [存档管理](/saves) — 基于剧本开始游戏或管理存档
- [角色卡](/cards) — 用户角色卡管理（NPC 转来的卡也在这里）
- [设定核对](/scripts-review) — 确认 AI 提取的人物/世界观/时间线内容无误
- [剧本编辑器](/md-editor) — VSCode 风格的剧本深度编辑入口
- [世界书](/worldbook) — 世界观条目说明
- [时间线](/timeline) — 时间线与故事进度说明
