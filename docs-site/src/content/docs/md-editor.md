---
title: "剧本编辑器"
description: "剧本编辑器是一个 VSCode 风格的三栏编辑环境，用于直接查看和修改剧本的全部知识资产——包括章节正文、角色卡、世界书条目、时间线锚点和 Canon 实体，五类实体统一在同一个界面里浏览与编辑。每个实体在编辑器中以「Y"
---
...
- [剧本管理](/scripts) — 导入剧本、触发知识库重建、管理章节
- [角色卡](/cards) — 角色卡的完整字段说明与游戏内行为
- [世界书](/worldbook) — 世界书条目的注入机制与批量操作
- [时间线](/timeline) — 时间线锚点的结构与进度推进
- [游戏内 AI 助手](/game-composer) — 游戏中同款 AI 助手的写权限档位说明
