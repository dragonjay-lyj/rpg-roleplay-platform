---
title: "分支管理"
description: "分支管理让你把每个存档的对话历史视为一棵「版本树」——每一回合是一个节点，每次从历史节点重走都会在树上开出新的分叉轨道，原路线完整保留。你可以从任意历史节点新建分支、切换到某条旧路线继续、或删除不想要的子树。"
---
...
- [存档管理](/saves) — 存档列表、重命名、删除
- [游戏主界面](/game-composer) — 游戏内对话与操作
